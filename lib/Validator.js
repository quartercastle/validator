...
module.exports = class Validator {
  ...
  compareArray (value, type, context) {
    if (!value || !Array.isArray(value)) {
      return this.setError(context, `isn't an array`, value)
    }
  ...
  compareObject (value, type, context) {
    if (!value || Array.isArray(value) || typeof value !== 'object') {
      return this.setError(context, `isn't an object`, value)
    }

    for (let key in value) {
      if (!type[key]) {
        this.setError(context.concat(key), `isn't defined in the schema`, value)
      }
    }
